...
/**
 * Write a description of class DuniaGweh here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DuniaGweh extends World
{
    ...
    {    
        ...
        this.setPaintOrder(Character.class, Boards.class, Proses.class, Environments.class);
        accBoard = new Boards();
